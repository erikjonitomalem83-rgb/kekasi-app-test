  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
      <div className="bg-white w-full max-w-5xl max-h-[90vh] rounded-2xl shadow-2xl flex flex-col overflow-hidden animate-in fade-in zoom-in duration-200">
        {/* Header */}
        <div className="p-6 border-b border-white/10 flex items-center justify-between bg-[#dc2626]">
          <div>
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-6 bg-gray-50/50">
          ...
          <div className="grid grid-cols-3 gap-2">
            <div className="bg-white p-2.5 rounded-lg border border-red-100 shadow-sm flex items-center justify-between">
              <div>
                <p className="text-[10px] font-semibold text-red-500 uppercase tracking-wider">Libur Nasional</p>
                <h3 className="text-xl font-bold text-gray-800">{stats.nasional}</h3>
              </div>
            ...
            <div className="bg-white p-2.5 rounded-lg border border-blue-100 shadow-sm flex items-center justify-between">
              <div>
                <p className="text-[10px] font-semibold text-blue-500 uppercase tracking-wider">Cuti Bersama</p>
                <h3 className="text-xl font-bold text-gray-800">{stats.cuti}</h3>
              </div>
            ...
            <div className="bg-white p-2.5 rounded-lg border border-amber-100 shadow-sm flex items-center justify-between">
              <div>
                <p className="text-[10px] font-semibold text-amber-500 uppercase tracking-wider">Total Hari Libur</p>
          ...
          <div className="flex justify-end gap-2">
            <button
              ...
              className="px-3 py-1.5 bg-red-50 text-red-600 border border-red-100 rounded-lg font-bold hover:bg-red-600 hover:text-white transition flex items-center gap-1.5 shadow-sm disabled:opacity-50 disabled:cursor-not-allowed text-sm"
            >
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path
                  strokeLinecap="round"
            ...
            <button
              ...
              className={`px-3 py-1.5 rounded-lg font-bold transition flex items-center gap-1.5 shadow-sm text-sm ${
          ...
          <div className="bg-white p-3 rounded-xl shadow-sm border border-gray-100 flex flex-wrap gap-3 items-center">
            <div className="flex items-center gap-2">
              ...
              <select
                className="px-3 py-1.5 border rounded-lg focus:ring-2 focus:ring-indigo-500 outline-none transition-all text-sm"
                value={filterYear}
            ...
            <div className="relative flex-1 min-w-[200px]">
              <input
                ...
                className="w-full pl-10 pr-4 py-1.5 border rounded-lg focus:ring-2 focus:ring-indigo-500 outline-none transition-all text-sm"
                value={searchTerm}
