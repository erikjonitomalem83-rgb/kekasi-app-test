...
const NomorSuratForm = ({
  ...
  return (
    <div className="bg-white rounded-xl shadow-sm md:shadow-md border border-gray-200 max-w-sm md:max-w-lg mx-4 md:mx-auto overflow-hidden min-h-[500px] md:min-h-[480px] flex flex-col">
