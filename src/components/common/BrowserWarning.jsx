      ...
      <div className="container mx-auto flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-sm">
              Browser Anda menyebabkan masalah performa dan dapat mengganggu pengguna lain. 
              Silakan gunakan <strong>Google Chrome</strong> atau <strong>Microsoft Edge</strong>.
            </p>
          </div>
        </div>
